...
<!-------------------select product-------->
                        <form action="adm_prod.php" method="get" class="form-inline">
...
<!---------------------------------------Product info--------------------------------------------->   
 <div class="overflow-auto" style=" max-height: 190px; overflow-y: auto;">
                    <table class="table table-bordered table-dark table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            if ($prod_id === '') {
                                ...
                                $query = "SELECT * FROM inv_items WHERE id='$prod_id'";
                            }

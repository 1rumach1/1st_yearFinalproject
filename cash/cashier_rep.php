...
<!-------------------------------- Main Content --------------------------------------->
                <main role="main" class="px-md-4">
                    <div class=" table table-responsive ">
                        <h2><?php echo $user_name; ?>'s Report</h2>
...
<!--------------------------------------display table------------------------------->
                    <div style="max-height: 250px; overflow-y: auto;">
                        <table class="table table-bordered table-dark table-hover table-striped">
                            ...
                            <tbody table-striped>
                            <?php
                                $query = "SELECT * FROM sales WHERE report='' AND _date = CURRENT_DATE() AND cart='out' AND who='$user_name' ORDER BY _time DESC";
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-primary" onclick="print()">Print Cashier's Report</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
        function print() {
            ...
            var url = 'c_report.php?overall=' + overall;      
            window.open(url);
        }
</script>
